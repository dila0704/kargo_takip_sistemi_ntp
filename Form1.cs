    ...
    public partial class Form1 : Form
    {
        ...
        private void btnOlustur_Click(object sender, EventArgs e)
        {
            ...
            if (cmbDurum.SelectedItem != null)
                gonderi.GonderiDurumu = (Durum)Enum.Parse(typeof(Durum), cmbDurum.SelectedItem.ToString());

            gonderiler.Add(gonderi);

            ListeyiYenile();  // Ekranı güncelle
            DosyayaKaydet();  // Dosyaya yaz
        ...
        private void btnDurumGuncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                string takipNo = dataGridView1.CurrentRow.Cells["Takip No: "].Value.ToString();
                Gonderi g = gonderiler.FirstOrDefault(x =>x.TakipNo == takipNo);
